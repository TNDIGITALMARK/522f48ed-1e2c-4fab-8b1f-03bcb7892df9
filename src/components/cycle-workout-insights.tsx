...
export function CycleWorkoutInsights({ userId }: CycleWorkoutInsightsProps) {
  ...
  if (!cycle || !insights) {
    return (
      <Card className="bloom-card bg-gradient-to-br from-muted/30 to-muted/10 border-muted">
  ...
  return (
    <div className="space-y-6">
      {/* Header Section */}
      <Card className="bloom-card bg-gradient-to-br from-primary/5 to-accent/5 border-primary/20">
      ...
      {/* Phase Insight Card */}
      <Card className="bloom-card bg-gradient-to-br from-secondary/10 to-accent/10 border-secondary/30">
      ...
      {/* Bottom Tip */}
      <Card className="bloom-card bg-gradient-to-br from-accent/10 to-primary/5 border-accent/20">
