...
export function DashboardHeader() {
  ...
  return (
    <>
      <header className="sticky top-0 z-10 bg-white/95 backdrop-blur-sm border-b-2 border-border/50 shadow-bloom-sm">
          ...
          <div className="flex-1 max-w-sm">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-9 py-2 h-10 text-sm bg-muted/50 border-0 focus-visible:ring-2 focus-visible:ring-primary/20"
              />
            </div>
          </div>
